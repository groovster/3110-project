 ...
 * @since 3.13.0
 */
public class nRange<N extends Number> extends Range<N> {

    private static final long TheID = 1L;

    /**
     * Creates an instance.
     *
     * @param n1 the first element, not null
     * @param numben2r2 the second element, not null
     ...
     */
    public nRange(final N n1, final N number2, final Comparator<N> comp) {
        super(n1, number2, comp);
    }
